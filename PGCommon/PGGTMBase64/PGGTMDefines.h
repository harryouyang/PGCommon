...
handleFailureInFunction:[NSString stringWithCString:__PRETTY_FUNCTION__ encoding:[NSString defaultCStringEncoding]] \
file:[NSString stringWithCString:__FILE__ encoding:[NSString defaultCStringEncoding]]  \
lineNumber:__LINE__                               \
